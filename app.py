...
# --- 3. TRABALHOS (SUBMISSÃO + STATUS) ---
    ...
    with tab1:
        st.write("Consulte abaixo as normas e utilize o link do formulário para enviar o seu arquivo Word.")
        tabs_normas = st.tabs(["📄 Resumo Simples", "📑 Resumo Expandido", "📚 Artigo Completo"])
        with tabs_normas[0]:
        ...
        with tabs_normas[1]:
            ...
            st.write("4 a 7 páginas. Formato Word. Estrutura: Resumo, Palavras-chave, Introdução, Metodologia, Resultados e Discussão, Conclusão, Referências Bibliográficas.")
        with tabs_normas[2]:
            st.markdown("### Normas para Submissão de Artigo Completo")
            st.write("8 a 16 páginas. Formato Word. Estrutura: Resumo, Palavras-chave, Introdução, Metodologia, Resultados e Discussão, Conclusão, Referências Bibliográficas.")
        
        st.link_button("📥 Acessar Formulário de Submissão", "COLE_LINK_SUBMISSAO_AQUI")

    with tab2:
        st.write("Digite o e-mail cadastrado para verificar o parecer da comissão científica.")
        email_busca = st.text_input("E-mail cadastrado:")
